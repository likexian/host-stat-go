...
type IOStat struct {
    ...
    ReadKBytes   uint64 `json:"read_kbytes"`   // rkB/s
    WriteKBytes  uint64 `json:"write_kbytes"`  // wkB/s
}
...
func GetIOStat() (stat []IOStat, err error) {
    ...
    for _, v := range lines {
        ...
        io_stat.ReadKBytes = io_stat.ReadSectors * 512 / 1024
        io_stat.WriteKBytes = io_stat.WriteSectors * 512 / 1024
